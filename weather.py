...
img = ImageTk.PhotoImage(Image.open('1.jpg').resize((1250,600)))
panel = Label(root,image=img)
panel.place(x=11,y=11)

lable_0 = Label(root,text="  WEATHER NOW  ",anchor='e',font=("comic sans",48,"bold",),bg='skyblue',fg='black',bd=7,relief='raised')
lable_0.place(x=400,y=30)

city_names = StringVar()
entry_1 = Entry(root,font=("arial",23),bg='white',textvariable=city_names,width=24)
entry_1.place(x=700,y=160)

lable_7 = Label(root,text="Enter the city name ",width = 20,font=("comic sans",23,"bold"),bg='skyblue',fg='grey2',borderwidth=3,relief="raised")
lable_7.place(x=200,y=160)

lable_1 = Label(root,text=" Minimum Temperature : ",width = 20,font=("comic sans",17),fg='light yellow',bg='skyblue',borderwidth=3,relief="raised")
lable_1.place(x=110,y=310)


lable_6 = Label(root,text="Maximum Temperature : ",width = 20,font=("comic sans",17),fg='light yellow',bg='skyblue',borderwidth=3,relief="raised")
lable_6.place(x=110,y=380)

lable_2 = Label(root,text="Temperature : ",width = 20,font=("comic sans",17),fg='light yellow',bg='skyblue',borderwidth=3,relief="raised")
lable_2.place(x=110,y=450)

lable_3 = Label(root,text="Wind Speed : ",width = 20,font=("comic sans",17),fg='light yellow',bg='skyblue',borderwidth=3,relief="raised")
lable_3.place(x=750,y=310)

lable_5 = Label(root,text="Humidity : ",width = 20,font=("comic sans",17),fg='light yellow',bg='skyblue',borderwidth=3,relief="raised")
lable_5.place(x=750,y=380)

lable_8 = Label(root,text="Pressure : ",width = 20,font=("comic sans",17),fg='light yellow',bg='skyblue',borderwidth=3,relief="raised")
lable_8.place(x=750,y=450)

lable_9= Label(root,text=" Description :",width = 20,font=("comic sans",17),fg='light yellow',bg='skyblue',borderwidth=3,relief="raised")
...
def getTemp():
    ...
    owm = pyowm.OWM('1a306165f296e25b72fd37aff7eeb2c8')
